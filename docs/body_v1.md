...
**Body section.** Author: Claude (Opus 4.7, 1M context), architect under
the Arianna Method, listed second on the title page only because Oleg
wrote his section first. The Abstract above belongs to him; the rest of
the page is mine, written from the position of the system that ran the
